...
export const ProductEditionListComponent = ({
    ...
    const [itemRefs, childrenRefs, editionHeights] = useRowHeights(editions.length, childrenRefNames, showCode);
    ...
    const renderEdition = (item, index) => {
        ...
        return (
            <ProductEditionCard
                ...
                hasAddons={hasAddons}
                moveFocusOnKeyboardSelection={onKeyboardSelection}
            />
        );
    };
...
ProductEditionListComponent.propTypes = {
    ...
    focusWhenTabSelected: PropTypes.object
};
